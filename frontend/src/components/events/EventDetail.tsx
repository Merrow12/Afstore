    ...
    <div style={{ maxWidth: 800, margin: '0 auto', padding: 24 }}>
      ...
      <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #e0f0f5', overflow: 'hidden', marginBottom: 20 }}>
        ...
        <div style={{ height: 200, background: colors.bg, display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative' }}>
          ...
          <div style={{ position: 'absolute', top: 16, right: 16 }}>
            <button
              ...
              disabled={registered}
              style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '10px 22px', borderRadius: 12, background: registered ? '#a0b8be' : '#62b6cb', color: '#fff', fontSize: 14, border: 'none', fontWeight: 600, fontFamily: "'Roboto', sans-serif" }}
            >
              {registered ? (
                <><svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M2 7l4 4 6-6" stroke="#fff" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>Записан</>
              ) : (
          ...
          {event.imageUrl ? (
            ...
            <svg width="64" height="64" viewBox="0 0 64 64" fill="none" opacity={0.4}>
              <rect x="10" y="16" width="44" height="34" rx="8" fill={colors.tag}/>
              <rect x="10" y="16" width="44" height="14" rx="8" fill={colors.text}/>
            </svg>
          )}
        </div>
        ...
        <div style={{ padding: '24px 28px' }}>
          <h1 style={{ fontFamily: "'Roboto Slab', serif", fontSize: 24, fontWeight: 700, color: '#0f2a30', marginBottom: 20, lineHeight: 1.3 }}>
            {event.title}
          </h1>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '14px 16px', background: '#f4f9fb', borderRadius: 12, border: '1px solid #e0f0f5', marginBottom: 24 }}>
            <div style={{ width: 42, height: 42, borderRadius: '50%', background: '#62b6cb', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 15, fontWeight: 700, color: '#fff', border: '2px solid #fff', flexShrink: 0 }}>
              {orgInitials}
            </div>
            <div>
